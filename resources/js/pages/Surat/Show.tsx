...
import { LetterParams, TypeLetterParams } from '../Surat/Type';
...
const Detail = ({
    ...
    type_letters: TypeLetterParams[];
    page_settings: PageSettings;
    document?: LetterParams;
}) => {
                        ...
                        <form className="p-2">
                            <div className="grid w-full gap-3">
                                <div className="w-full">
                                    ...
                                    <Select name="type_letter_id" value={`${document?.type_letter_id}`} disabled>
                                        <SelectTrigger>
                                        ...
                                        {isFile && document?.is_private == false ? (
                                            ...
                                            <div className="flex items-center gap-5">
                                                <div className="flex items-center gap-2">
                                                    <div className="flex items-center space-x-4">
                                                        <File className="size-5 text-gray-500" />
                                                        <h3 className="text-md font-semibold">Surat Terkunci</h3>
                                                    </div>
                                                </div>
                                                <LockIcon />
                                            </div>
