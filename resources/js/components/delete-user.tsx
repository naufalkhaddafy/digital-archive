            ...
            <div className="space-y-4 rounded-lg border border-red-100 bg-red-50 p-4 dark:border-red-200/10 dark:bg-red-700/10">
                ...
                <Dialog>
                    ...
                    <DialogContent>
                        ...
                        <DialogDescription>
                            Jika akun Anda dihapus, semua sumber daya dan data akan dihapus secara permanen. Silakan masukkan kata sandi Anda untuk
                            mengonfirmasi Anda ingin menghapus akun Anda secara permanen.
                        </DialogDescription>
